...
type DealsOneMenuProps = React.DetailedHTMLProps<
  React.HTMLAttributes<HTMLDivElement>,
  HTMLDivElement
> &
  Partial<{}>;

const DealsOneMenu: React.FC<DealsOneMenuProps> = (props) => {
  return (
    <>
        ...
        <div className="flex flex-col gap-12 items-start justify-start w-full">
          ...
          <div className="flex items-start justify-start self-stretch w-auto">
            <div className="flex flex-col gap-6 items-start justify-start md:pl-10 pl-12 sm:pl-5 self-stretch w-auto">
              ...
              <div className="flex flex-row gap-3 items-center justify-start ml-auto self-stretch w-auto">
                <Img
                  src="images/img_heroiconsoutlineinboxstack.svg"
                  className="h-6 w-6"
                  alt="heroiconsoutlin"
                />
                <Text
...
DealsOneMenu.defaultProps = {};

export default DealsOneMenu;
